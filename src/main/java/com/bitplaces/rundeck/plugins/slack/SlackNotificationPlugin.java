 ...
 */
@Plugin(service= "Notification", name="SlackNotificationCustom")
@PluginDescription(title="Slack Incoming WebHook Custom", description="Sends Slack message, built by Cherwell")
public class SlackNotificationPlugin implements NotificationPlugin {
    ...
    private static final String SLACK_EXT_MESSAGE_TEMPLATE_PATH = "C:/rundeck/libext/templates";
    ...
    @PluginProperty(
            title = "WebHook Url",
            description = "WebHook URL to used to send the message. Ex. https://hooks.slack.com/services/XXXXXX/XXXXXX/XXXXXXXXXXXXXXXXXXXX",
            required = true,
    ...
    public boolean postNotification(String trigger, Map executionData, Map config) {
        ...
        //Select the correct room (channel) based on RD systemtype
        String systemtype = System.getenv("RD_CUSTOM_SYSTEMTYPE");
        
        if (systemtype.equals("PROD")){
            room = room_prod;
        } else if (systemtype.equals("DEV")){
            room = room_dev;
        }
        System.err.println("DEBUG: Room_PROD is set to " + room_prod);
        System.err.println("DEBUG: Room is set to " + room);
        System.err.println("DEBUG: SYSTEMTYPE is set to " + systemtype);
